...
class JFormFieldKSMCategories extends JFormFieldCheckboxes{
	...
	public function getInput(){
		...
		$script='
		jQuery(".ksm-slidemodule-ksmcategories ul li a.show").live("click",function(){
		...
		jQuery(".ksm-slidemodule-ksmcategories ul li a.hides").live("click",function(){
	...
	function buildCategoriesTree() {
        ...
        foreach ($categories as $id=>$category){
			if (!empty($this->value) && in_array($id,$this->value))
