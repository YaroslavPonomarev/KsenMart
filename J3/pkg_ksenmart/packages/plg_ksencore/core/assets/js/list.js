var KMList = function(variables){
	...
	this.setListScrolling = function(){
		...
		{
			jQuery('#content .top').css({'width':jQuery('#content .cat').width()});
			class_name='scrolling';
		}	
		jQuery('#content .cat thead .stretch').css({'width':jQuery('#content .cat thead .stretch').width()});	
	...
	this.setListSorting = function(){
		...
		jQuery('#content .cat thead .sort_field').live('click',function(){
	...
	this.setListItemsSortable = function(){
		...
		jQuery('#content .cat tbody .stretch').css({'width':jQuery('#content .cat thead .stretch').width()});		
	...
	this.setListButtons = function(){
		...
		{
			jQuery('#content .top .delete-items').live('click',function(){
		...
		if (List.copy_button)
		{
			jQuery('#content .top .copy-items').live('click',function(){
	...
	this.setItemsActions = function(){
		...
		jQuery('#content .cat .list_item .changeble').live('keypress',function(e){
			if (e.keyCode==13)
			{
		...
		jQuery('#content .cat .list_item').live('click',function(){
		...
		jQuery('#content .cat .list_item input[type="checkbox"]').live('click',function(){
			var data={};
	...
	this.setListDeleting = function(){
		var List=this;
		jQuery('#content .cat .list_item .del a').live('click',function(){
		...
		jQuery('#content .cat th.del span').live('click',function(){
			if (confirm(Joomla.JText._('KSM_DELETE_CONFIRMATION'))) {
				var data={"items":[]};
	...
	this.scrollTopList = function(){
		jQuery('body,html').animate({'scrollTop':jQuery('#cat').offset().top},500);
	}
