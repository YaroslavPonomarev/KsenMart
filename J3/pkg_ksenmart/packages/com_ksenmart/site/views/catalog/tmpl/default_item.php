		...
		<form method="post" action="<?php echo $this->product->add_link_cart; ?>" class="clearfix">        
			...
			<div class="caption clearfix">
                <div class="bottom_wrapp span12">
					<div class="price row-fluid"<?php echo $this->product->val_price_wou == 0?' style="visibility: hidden;"':''; ?>>
                        <div class="span6">
                    ...
                    <div class="bottom span12">
                        ...
                        <?php if(!$this->params->get('only_auth_buy', 0) && ($this->product->val_price_wou != 0 && $this->product->is_parent == 0 && $flag)){ ?>	
        					<div class="buy">
