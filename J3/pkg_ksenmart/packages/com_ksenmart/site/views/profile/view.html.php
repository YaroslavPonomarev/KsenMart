    ...
    public function display($tpl = null) {
        ...
        switch ($layout) {
            ...
            default:
                ...
                $document->addScript(JURI::base() . 'administrator/modules/mod_km_account_info/js/jquery.Jcrop.min.js', 'text/javascript', true);
                ...
                $document->addStyleSheet(JURI::base().'administrator/modules/mod_km_account_info/css/jquery.Jcrop.min.css');
