...
<div id="center">
	<table id="cat" width="100%">
		<tr>
			...
			<td valign="top">
				<form action="<?php echo JRoute::_('index.php?option=com_ksenmart');?>" id="settings-form" method="post" class="form" name="adminForm" autocomplete="off" class="form-validate">
