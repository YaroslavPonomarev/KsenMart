...
<div class="login-screen clearfix">
    ...
    <form id="login_form" action="index.php?option=com_ksenmart&task=account.setAuth&tmpl=ksenmart" method="POST" class="login_block login-form pull-right">
        <div class="msg"></div>
    ...
    <form id="reg_form" action="index.php?option=com_ksenmart&task=account.setReg&tmpl=ksenmart" method="POST" class="reg_block login-form pull-right" style="display: none;">
        <div class="msg"></div>
        <div class="control-group">
    ...
    jQuery(document).ready(function(){
        ...
        function onSuccessLogin(data){
            ...
            if(data == ''){
                ...
                ls_login_form.attr('action', 'index.php?option=com_ksenmart&task=account.setNewPass&tmpl=ksenmart');
