...
define('ACCOUNT_ROOT_MODULE_PATCH', JPATH_ROOT.'/administrator/modules/mod_km_account_info/images/avatars/');
 ...
 * @access public
 */
class KsenMartModelAccount extends JModelKSAdmin {
    ...
    public function getEncryptAuth() {
        $query = $this->_db->getQuery(true);
        $query->select("AES_DECRYPT(`data`, 'poka_testovay') AS data")->from('#__ksenmart_billing_data')->
