...
class KsenMartModelPanel extends JModelKSAdmin {
    ...
    function getWidgets() {
        ...
        if($widget_type != 'all') {
            ...
            $query->innerjoin('#__ksenmart_widgets_types as kwt on kwtv.type_id=kwt.id and kwt.name=' . $this->_db->quote($widget_type));
        }
        ...
        foreach($widgets as &$widget) {
            $widget->image = JURI::root() . '/media/com_ksenmart/images/icons/' . $widget->image;
            $widget->info = '';
