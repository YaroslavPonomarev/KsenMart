...
class KsenMartModelOrders extends JModelKSAdmin {
    ...
    function getListItems() {
        ...
        foreach($orders as &$order) {
            ...
            if(isset($order->customer_fields['lastname']) && !empty($order->customer_fields['lastname'])) $order->customer_info .= $order->customer_fields['lastname'] . ' ';
            if(isset($order->customer_fields['name']) && !empty($order->customer_fields['name'])) $order->customer_info .= $order->customer_fields['name'] . ' ';
            if(isset($order->customer_fields['surname']) && !empty($order->customer_fields['surname'])) $order->customer_info .= $order->customer_fields['surname'];
