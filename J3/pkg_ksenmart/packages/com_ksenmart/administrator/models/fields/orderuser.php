...
class JFormFieldOrderUser extends JFormField {
	...
	public function getInput(){
		...
		{
			$html.='<div class="row">';
			$html.='	<a href="'.JRoute::_('index.php?option=com_ksenmart&view=users&layout=search&items_tpl=orderuser&items_to=ksm-slidemodule-orderuser-container&tmpl=component').'" class="add">'.JText::_('ksm_add').'</a>';
			$html.='</div>';
		}
		$html.='</div>';

		$script='
		jQuery(".ksm-slidemodule-orderuser .add").live("click", function(){
		...
		jQuery(".ksm-slidemodule-orderuser .del").live("click", function(){
