...
class JFormFieldPropertyValues extends JFormField {
	...
	public function getInput() {
		...
		foreach($this->value as $value)
		{
			...
			if ($value->image!='')
				$html.='			<img height="30px" src="'.JURI::root().$value->image.'">';
		...
		jQuery(".ksm-slidemodule-propertyvalues .add").live("click",function(){
			var html="";
		...
		jQuery(".property-clear-image").live("click",function(){
		...
		jQuery(".show-value-alias").live("click",function(){
		...
		jQuery(".ksm-slidemodule-propertyvalues .del").live("click",function(){
