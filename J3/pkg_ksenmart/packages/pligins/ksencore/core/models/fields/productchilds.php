...
class JFormFieldProductChilds extends JFormField {
	...
	public function getInput() {
		...
		jQuery(document).ready(function(){
			...
			jQuery(".positions-group .sh").on("click",function(){
			...
			jQuery(".position .delete-pos").on("click",function(){
			...
			jQuery(".positions-group .del").click(function(){
				if (confirm(Joomla.JText._("KSM_DELETE_CONFIRMATION")))
				{
			...
			jQuery(".position .checkbox").on("click",function(){
				var item=jQuery(this).parents(".position:first");
				if (item.is(".active"))
			...
			jQuery(".position .inputbox").on("click",function(){
				jQuery(this).focus();
			});
