<ul class="inline account_login_menu">
    <li>
        <a href="javascript:void(0);" title="<?php echo JText::_('MOD_JOOMLAID_LOGIN_TITLE'); ?>" id="login_form_show"><?php echo JText::_('MOD_JOOMLAID_LOGIN_TITLE'); ?></a>
    </li>
    <li> | </li>
    <li>
        <a href="javascript:void(0);" title="<?php echo JText::_('MOD_JOOMLAID_REGISTRATION_TITLE'); ?>" id="reg_form"><?php echo JText::_('MOD_JOOMLAID_REGISTRATION_TITLE'); ?></a>
    </li>
</ul>
